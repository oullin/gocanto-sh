...
import { Activity, Code2, Home, Lock, Server, Shield, type LucideIcon } from "lucide-vue-next";
        ...
        <div class="mx-auto max-w-page px-6 py-[120px]">
            <div class="mx-auto mb-16 max-w-[720px] text-center">
                ...
                >
                    ...
                    <span class="text-fg-3">contact with production.</span>
                </h2>
                <p class="mx-auto mt-[18px] max-w-[580px] text-[16.5px] leading-[1.55] text-fg-2">
                    Architecture, backend systems, reliability, and the technical tradeoffs that
                    decide whether a system survives its first real load.
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div class="text-base font-semibold tracking-[-0.02em]">
                        {{ feature.title }}
                    </div>
                    <p class="mt-2.5 text-[14.5px] leading-[1.55] text-fg-2">
                        {{ feature.description }}
                    </p>
                </div>
            </div>
