...
export const aboutCopy: AboutCopy = {
    paragraphs: [
        {
            text: "I'm a software architect and engineering leader based in Singapore. Two decades shipping production systems for banking, fintech, payments, e-commerce, healthtech, and cybersecurity — the kind of work that has to keep working at 3am.",
        },
        {
            text: "Currently working with teams as Head of Engineering, fractional engineering lead, and founding engineer — turning prototypes into production-grade software, and production-grade software into platforms that scale.",
        },
    ],
...
export const journeyHeading = {
    ...
    lead: "I've worked as Head of Engineering, Engineering Lead, and Founding Engineer across banking, fintech, payments, e-commerce, healthtech, and cybersecurity — in Singapore and beyond.",
    highlights: [
...
export const faqs: FaqItem[] = [
    {
        ...
        answer: 'Architecture reviews, fractional engineering leadership, founding-engineer work, and "turn-the-prototype-into-production" engagements. Anything where the bottleneck is technical judgment, not just headcount.',
    },
    {
        question: "Remote, hybrid, or on-site?",
        answer: "Based in Singapore (UTC+8), comfortable working remote with global teams. Happy to travel for offsites, kickoffs, and the moments where being in the room matters.",
    },
    {
        question: "Which domains do you take on?",
        answer: "Strongest in banking, fintech, cross-border payments, and e-wallets. Also shipped at scale in e-commerce, healthtech, and cybersecurity. Production rigor transfers across all of them.",
    },
    {
        question: "How do you think about AI in the stack?",
        answer: "As a multiplier, not a strategy. AI accelerates what teams produce; it doesn't change what's hard — knowing what to build, building it safely, and keeping it observable.",
    },
    {
        question: "What's the fastest way to start?",
        answer: "A short intro on LinkedIn with the problem you're trying to solve. From there we usually do a 30-minute scoping call before deciding whether the engagement is a fit.",
    },
];
...
export const connectHeading = {
    ...
    trailing: ".",
    subtitle:
        "LinkedIn is best for engagement inquiries. Pick whichever channel fits the conversation.",
} as const;
